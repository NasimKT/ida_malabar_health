...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow-sm px-5 py-3 py-lg-0">
        ...
        <img style="margin-left: 10%;" id="logo" src="img/emblem.jpg" alt="logo" />
    ...
    <div class="achu4">
        <div class="achu4">
            <div class="row g-5" id="clinic-container">
                <div class="main-div">
    ...
    const clinics = [{
        ...
        {
            name: 'MARIA DENTAL CLINIC & ORTHODONTIC CENTRE',
        ...
        {
            name: 'QUEEN HAUORA DIGITAL DENTISTRY & AESTHETIC CLINIC',
            imageSrc: 'img/2022-11-18.jpg',
            socialLinks: ['https://maps.app.goo.gl/uDnoKdqhv7PcLovY7'],
            location: 'ARAYIDATHUPALAM',
            knowmorelink: 'https://www.queenhauora.com/',
            hasWheelchairAccess: true,
            hasRampAccess: true,
            hasLiftAccess: true
        },
        {
            name: 'ORBIT DENTAL CARE',
            imageSrc: 'img/16957175676476836762643385017938 - ANJALI TK.jpg',
            socialLinks: ['https://maps.app.goo.gl/fmwFVXcZTvWv7py58'],
            location: 'PERAMBRA',
            knowmorelink: 'https://search.brave.com/search?q=www.+Google+Orbit+dental+care&source=desktop',
            hasWheelchairAccess: true,
            hasRampAccess: true,
            hasLiftAccess: false
        },
        ...
        },
        {
            ...
            knowmorelink: 'https://www.google.com/search?q=KARTHIKA+DENTAL+CLINIC+%26+SPECIALTY+CENTRE%2C+FATHIMA+SHOPPING+COMPLEX%2C+THAMARASSERY%0D%0A&sca_esv=582496584&sxsrf=AM9HkKlCbXaTawNklRd5VEq0wD1lZUEHnQ%3A1700017449450&ei=KTVUZeuMG6Gb4-EPvP6_sAM&ved=0ahUKEwirxb7BgsWCAxWhzTgGHTz_DzYQ4dUDCBA&uact=5&oq=KARTHIKA+DENTAL+CLINIC+%26+SPECIALTY+CENTRE%2C+FATHIMA+SHOPPING+COMPLEX%2C+THAMARASSERY%0D%0A&gs_lp=-AEB-AECqAIU4gMEGAAgQYgGAboGBggBEAEYCw&sclient=gws-wiz-serp',
            hasWheelchairAccess: true,
            hasRampAccess: true,
            hasLiftAccess: false
        },
        {
            ...
            knowmorelink: 'https://www.google.com/search?q=AL+SANAH+DENTAL+CLINIC+FRANCIS+ROAD&sca_esv=582496584&sxsrf=AM9HkKmxQUPJdGIV8UiDr10tu6F0E4n16w%3A1700017465819&ei=OTVUZcHDMd3G4-EPrvqcyAk&ved=0ahUKEwiBxKXJgsWCAxVd4zgGHS49B5kQ4dUDCBA&uact=5&oq=AL+SANAH+DENTAL+CLINIC+FRANCIS+ROAD&gs_lp=Egxnd3Mtd2l6LXNlcnAiI0FMIFNBTkFIIERFTlRBTCBDTElOSUMgRlJBTkNJUyBST0FEMgcQIRigARgKMgcQIRigARgKSM5AUO4FWO0-&sclient=gws-wiz-serp',
            hasWheelchairAccess: true,
            hasRampAccess: false,
            hasLiftAccess: false
        },
        ...
        },
        {
            ...
            knowmorelink: 'https://www.google.com/search?q=DR+ARUN+GEORGE+SONY+DENTAL+CLINIC&sca_esv=582496584&sxsrf=AM9HkKlPG4BMi4ZSzmLxY8mxmGUNItFM5A%3A1700017773944&ei=bTZUZaGTOeDF4-EP8ouQSA&ved=0ahUKEwjh_Zvcg8WCAxXg4jgGHfIFBAkQ4dUDCBA&uact=5&oq=DR+ARUN+GEORGE+SONY+DENTAL+CLINIC&gs_lp=&sclient=gws-wiz-serp																					',
            hasWheelchairAccess: true,
            hasRampAccess: true,
            hasLiftAccess: false
        },
        ...
        },
        {
            ...
            socialLinks: ['#'],
            location: 'OLD CO-ORPORATION OFFICE',
        ...
        // Function to create a clinic card
                ...
                <div class="main-div">
                        <div class="team-item">
                            <div class="position-relative rounded-top" style="z-index: 1;">
                                <img class="img-fluid rounded-top w-100" src="${clinic.imageSrc}" alt="">
                                <div class="position-absolute top-100 start-50 translate-middle bg-light rounded p-2 d-flex">
                                    ${clinic.socialLinks.map(link => `<a class="btn btn-primary btn-square m-1" href="${link}"><i class="material-icons" style="color:rgb(15, 15, 15)">add_location</i></a>`).join('')}
                                </div>
                            </div>
        ...
        function displayClinics(clinicList) {
            ...
            clinicContainer.innerHTML = `<nav>
                        <ul>
                            <li  id="lift-btn"
                            onclick="showAll()">Show All</li>
                            <li id="lift-btn"
                            onclick="liftClinics()">Lift</li>
                            <li id="wheel-btn"
                            onclick="wheelClinics()">Ground floor</li>
                            <li id="ramp-btn"
                            onclick="rampClinics()">Ramp</li>                   
                        </ul>
                    </nav>
                    <div class="col-lg-4 wow slideInUp" data-wow-delay="0.1s">
                        <div class="section-title bg-light rounded h-100 p-5">
                            <h5 class="position-relative d-inline-block text-primary text-uppercase">Our Dentist</h5>
                            <h1 class="display-6 mb-4">Meet Our Certified Clinics And Hospitals</h1>
    ...
    function createClinicCard(clinic) {
        ...
        //const base64Image = btoa(String.fromCharCode.apply(null, new Uint8Array(clinic.imageSrc)));
        ...
        <div class="main-div">
            <div class="team-item">
                <div class="position-relative rounded-top" style="z-index: 1;">
                    <img class="img-fluid rounded-top w-100" src="uploads/${clinic.imageSrc}" alt="">
                    <div class="position-absolute top-100 start-50 translate-middle bg-light rounded p-2 d-flex">
    <a class="btn btn-primary btn-square m-1" href="${clinic.socialLinks}"><i class="material-icons" style="color:rgb(15, 15, 15)">add_location</i></a>
</div>
        ...
        <div class="main-div">
            <div class="team-item">
                <div class="position-relative rounded-top" style="z-index: 1;">
                    <img class="img-fluid rounded-top w-100" src="uploads/${clinic.imageSrc}" alt="">
                    <div class="position-absolute top-100 start-50 translate-middle bg-light rounded p-2 d-flex">
                        <a class="btn btn-primary btn-square m-1" href="${clinic.socialLinks}">
                            <i class="material-icons" style="color:rgb(15, 15, 15)">add_location</i>
                        </a>
                    </div>
                </div>
                <div class="team-text position-relative bg-light text-center rounded-bottom p-4 pt-5">
...
// Call fetchData with await to get data before further execution
async function initializeClinics() {
    clinics = await fetchData();
    displayClinics();
}


// Call initializeClinics to fetch and display data when the page loads
document.addEventListener('DOMContentLoaded', initializeClinics);

// Modify the displayClinics function to use the fetched data
function displayClinics(clinicsToDisplay = clinics) {
    const clinicContainer = document.getElementById('clinic-container');

    if (!clinicsToDisplay || clinicsToDisplay.length === 0) {
    ...
    clinicContainer.innerHTML = `<nav>
            <ul>
                <li id="lift-btn" onclick="showAll()">Show All</li>
                <li id="lift-btn" onclick="liftClinics()">Lift</li>
                <li id="wheel-btn" onclick="wheelClinics()">Ground floor</li>
                <li id="ramp-btn" onclick="rampClinics()">Ramp</li>
            </ul>
        </nav>
        <div class="col-lg-4 wow slideInUp" data-wow-delay="0.1s">
            <div class="section-title bg-light rounded h-100 p-5">
...
// Function to filter clinics based on wheelchair access
function filterClinics(property, value) {
    return clinics.filter(clinic => clinic[property] === value);
}

function wheelClinics() {
    const filteredClinics = filterClinics('hasWheelchairAccess', 1);
    displayClinics(filteredClinics);
}

function rampClinics() {
    const filteredClinics = filterClinics('hasRampAccess', 1);
    displayClinics(filteredClinics);
}

function liftClinics() {
    const filteredClinics = filterClinics('hasLiftAccess', 1);
    displayClinics(filteredClinics);
}
...
document.addEventListener('DOMContentLoaded', initializeClinics);
    ...
    // Call the displayClinics function when the page loads
    window.onload = () => displayClinics(clinics);
    </script>
